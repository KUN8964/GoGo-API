# GO GO API Deployment Files

This directory contains files for deploying GO GO API on Linux servers.
...
GO GO API supports three methods to connect to Gemini:
...
GO GO API supports TLS fingerprint simulation to make requests appear as if they come from the official Claude CLI (Node.js client).
